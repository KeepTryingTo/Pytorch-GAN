...
@Time   : 2023/5/14 10:46
"""
# 数据集地址：https://github.com/NVlabs/ffhq-dataset
...
def run_cmdline(argv):
    ...
    parser.add_argument('--num_threads',        help='number of concurrent download threads (default: 32)', type=int, default=2, metavar='NUM')
    ...
    parser.add_argument('--source-dir',         help='where to find already downloaded FFHQ source data', default='data/', metavar='DIR')
