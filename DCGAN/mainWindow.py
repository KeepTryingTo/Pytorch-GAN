...
if __name__ == '__main__':
    ...
    #model = torch.load(f = 'models/gen.pth', map_location=lambda storage, loc: storage)
    model = torch.load(f = 'models/gen.pth', map_location = torch.device('cpu'))
    while True:
