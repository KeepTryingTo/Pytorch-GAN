...
"""
生成器通道数从:512 -> 512 -> 512 -> 512 -> 256 -> 128 -> 64 -> 32 -> 16 [-> 8 -> 4]
判别器通道数从:[4 -> 8 ->] 16 -> 32 -> 64 -> 128 -> 256 -> 512 -> 512 -> 512 -> 512
"""
...
class Generator(nn.Module):
    def __init__(self, z_dim, in_channels, img_channels=3):
        ...
        self.initial = nn.Sequential(
            PixelNorm(),
            nn.ConvTranspose2d(z_dim, in_channels, kernel_size=(4,4), stride=(1,1) ,padding=(0,0)),
            nn.LeakyReLU(0.2),
        ...
        #self.rgb_layers表示每一个convblock之后的将特征图转换为rgb图像
...
if __name__ == "__main__":
    ...
    for img_size in [4, 8, 16, 32, 64, 128, 256, 512, 1024]:
        ...
        print(f"Success! At img size: {img_size}-------------num_steps: {num_steps}")